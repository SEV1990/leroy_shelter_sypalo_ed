...
export const SEED_TEAM = [
  { name: 'Олексій Коваль', insta: '@saveanimals_ukraine', role: 'Засновник · Керівник евакуацій', descr: 'З першого дня організовує виїзди в зони бойових дій. Особисто бере участь у найнебезпечніших операціях.', photo: '/assets/img/team1.jpg', sort: 1 },
  { name: 'Марія Лисенко', insta: '', role: 'Ветеринарний координатор', descr: 'Ветеринарка з 10-річним досвідом. Забезпечує медичний супровід всіх евакуйованих тварин.', photo: '/assets/img/team2.jpg', sort: 2 },
  { name: 'Дмитро Савченко', insta: '', role: 'Логістика · Транспорт', descr: 'Організовує всі маршрути евакуації. Знає кожну дорогу Донеччини та Херсонщини.', photo: '/assets/img/team3.jpg', sort: 3 },
  { name: 'Аня Петренко', insta: '', role: 'Куратор шелтеру', descr: 'Відповідає за щоденний догляд тварин. Організовує пошук нових родин.', photo: '/assets/img/team4.jpg', sort: 4 },
  { name: 'Сергій Іванченко', insta: '', role: 'Волонтер-евакуатор', descr: 'Понад 50 виїздів. Спеціалізується на роботі з агресивними тваринами.', photo: '/assets/img/team5.jpg', sort: 5 },
  { name: 'Катерина Мороз', insta: '@saveanimals_ukraine', role: 'SMM · Комунікації', descr: 'Веде Telegram-канал на 7 000+ підписників. Організовує благодійні заходи.', photo: '/assets/img/team6.jpg', sort: 6 },
];
